        ...
        ">
            ...
            <div class="box-body">
                <!-- TODO: in config\pterodactyl.php we need to update the CDN URL and add version checking again. -->
                    You are running softpanel panel version <code>{{ config('app.version') }}</code>.
            </div>
        </div>
    </div>
</div>
<div class="row">
    <div class="col-xs-6 col-sm-3 text-center">
        <a href="https://t.me/gotdrugs"><button class="btn btn-warning" style="width:100%;"><i class="fa fa-fw fa-support"></i> Get Help <small>(via Telegram)</small></button></a>
    </div>
    <div class="col-xs-6 col-sm-3 text-center">
    ...
    <div class="col-xs-6 col-sm-3 text-center">
        <a href="https://github.com/kaneious/panel"><button class="btn btn-primary" style="width:100%;"><i class="fa fa-fw fa-support"></i> Github</button></a>
    </div>
    <div class="col-xs-6 col-sm-3 text-center">
